...
**問い**: いまのターンで LLM に渡すノードはどれか。

| 渡し方 | 結果 |
| --- | --- |
| ファイル | jira / slack / email … 毎回ブレやすい |
| グラフ | INC-001, acme-search, globex に固定 |
...
渡す範囲をあらかじめ固定すると、コンテキストの揺れを抑えられます。
...
4. 渡すノード範囲を固定すると、エージェントへの材料が安定する
